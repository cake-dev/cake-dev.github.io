...
!function (t, n) {
    ...
    function ht(t, n) {
        var e = [], r = null, i = null, o = 6, a = 6, u = 3,
            c = "undefined" != typeof window && window.devicePixelRatio > 1 ? 0 : .5, f = 1 === t || 4 === t ? -1 : 1,
            s = 4 === t || 2 === t ? "x" : "y", l = 1 === t || 3 === t ? ut : ct;

        function h(h) {
            var d = null == r ? n.ticks ? n.ticks.apply(n, e) : n.domain() : r,
                p = null == i ? n.tickFormat ? n.tickFormat.apply(n, e) : ot : i, g = Math.max(o, 0) + u, y = n.range(),
                v = +y[0] + c, _ = +y[y.length - 1] + c, b = (n.bandwidth ? st : ft)(n.copy(), c),
                m = h.selection ? h.selection() : h, x = m.selectAll(".domain").data([null]),
                w = m.selectAll(".tick").data(d, n).order(), M = w.exit(),
                A = w.enter().append("g").attr("class", "tick"), T = w.select("line"), S = w.select("text");
    ...
    Pn.prototype = zn.prototype = {
        constructor: Pn, select: function (t) {
            ...
            var e = n ? Bt : Ut, r = this._parents, i = this._groups;
    ...
    var zo = {
        ...
        Io = {overlay: 1, selection: 1, n: null, e: 1, s: null, w: -1, nw: -1, ne: 1, se: 1, sw: -1},
        Uo = {overlay: 1, selection: 1, n: -1, e: null, s: 1, w: null, nw: -1, ne: -1, se: 1, sw: 1};
        ...
        function h(e) {
            if ((!n || e.touches) && r.apply(this, arguments)) {
                var i, a, u, c, l, h, d, p, g, y, v, _ = this, b = e.target.__data__.type,
                    ...
                    x = t === Do ? null : Io[b], w = t === zo ? null : Uo[b], M = Ho(_), A = M.extent, T = M.selection,
                ...
                if ("overlay" === b) {
                    T && (g = !0);
                    const n = [D[0], D[1] || D[0]];
                    M.selection = T = [[i = t === Do ? S : No(n[0][0], n[1][0]), u = t === zo ? E : No(n[0][1], n[1][1])], [l = t === Do ? k : ko(n[0][0], n[1][0]), d = t === zo ? N : ko(n[0][1], n[1][1])]], D.length > 1 && U()
                ...
                if (e.touches) F.moved = I, F.ended = B; else {
            ...
            function I(t) {
                for (const n of t.changedTouches || [t]) for (const t of D) t.identifier === n.identifier && (t.cur = In(n, _));
                if (z && !y && !v && 1 === D.length) {
                    const t = D[0];
    ...
    class Fa {
        ...
        update() {
            ...
            for (let o, a, u = 0; u < this._ids.length; u++) {
                ...
                l = n[l];
                let g, y = l;
                for (; g = e[y], !Ua(f, s, t[2 * y], t[2 * y + 1], t[2 * g], t[2 * g + 1]);) if (y = g, y === l) {
                    y = -1;
                    break
                }
                if (-1 === y) continue;
                ...
                if (y === l) for (; g = n[y], Ua(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]);) v = this._addTriangle(g, c, y, -1, r[y], r[g]), this._legalize(v + 2), r[g] = v, e[y] = y, A--, y = g;
    ...
    Xu.copy = function () {
        ...
        for (g && p.push(new Uu(g, s, l, h, d)), null == e ? e = 1 / 0 : (s = t - e, l = n - e, h = t + e, d = n + e, e *= e); c = p.pop();) if (!(!(g = c.node) || (i = c.x0) > h || (o = c.y0) > d || (a = c.x1) < s || (u = c.y1) < l)) if (g.length) {
            var y = (i + a) / 2, v = (o + u) / 2;
        ...
        for (c && u.push(new Uu(c, this._x0, this._y0, this._x1, this._y1)); n = u.pop();) if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, a = n.y1) && c.length) {
            var f = (r + o) / 2, s = (i + a) / 2;
    ...
    function Ul(t, n) {
        var e = t - Al, r = n - Tl, i = Ic(e * e + r * r);
    ...
    function lh(t, n) {
        return +n ? function (t, n) {
            function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
                ...
                if (b > 4 * n && g--) {
                    var m = a + h, x = u + d, w = c + p, M = Ic(m * m + x * x + w * w), A = Yc(w /= M),
    ...
    function gh(t) {
        ...
        return E.stream = function (t) {
            ...
            return arguments.length ? (T = null == t ? (A = r = i = o = null, fl) : Us(A = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]), C()) : null == A ? null : [[A, r], [i, o]]
        }, E.scale = function (t) {
    ...
    function xh(t) {
        return function (n, e) {
            var r = Ic(n * n + e * e), i = t(r), o = Fc(i), a = Cc(i);
    ...
    function Eh(t, n) {
        ...
        return o.invert = function (t, n) {
            var e = i - n, o = Oc(r) * Ic(t * t + e * e), a = Nc(t, Ec(e)) * Oc(e);
    ...
    var Ch = 1.340264, Ph = -.081106, zh = 893e-6, Dh = .003796, qh = Ic(3) / 2;
    ...
    var Id = Math.random, Ud = function t(n) {
        function e(t, e) {
    ...
    var Lp = Yp.range;
    const jp = 1e3, Hp = 6e4, Xp = 36e5, Gp = 864e5, Vp = 6048e5, $p = 2592e6, Wp = 31536e6;
    ...
    var og = ig(0), ag = ig(1), ug = ig(2), cg = ig(3), fg = ig(4), sg = ig(5), lg = ig(6), hg = og.range,
        dg = ag.range, pg = ug.range, gg = cg.range, yg = fg.range, vg = sg.range, _g = lg.range,
        bg = Bp((function (t) {
    ...
    var wg = xg.range, Mg = Bp((function (t) {
        t.setUTCSeconds(0, 0)
    }), (function (t, n) {
        t.setTime(+t + n * Hp)
    }), (function (t, n) {
    ...
    var Cg = Ng(0), Pg = Ng(1), zg = Ng(2), Dg = Ng(3), qg = Ng(4), Rg = Ng(5), Fg = Ng(6), Og = Cg.range,
        Ig = Pg.range, Ug = zg.range, Bg = Dg.range, Yg = qg.range, Lg = Rg.range, jg = Fg.range,
        Hg = Bp((function (t) {
    ...
    function $g(t, n, r, i, o, a) {
        ...
        function c(n, r, i) {
            const o = Math.abs(r - n) / i, a = e((([, , t]) => t)).right(u, o);
    ...
    function ey(t) {
        var n = t.dateTime, e = t.date, r = t.time, i = t.periods, o = t.days, a = t.shortDays, u = t.months,
            c = t.shortMonths, f = sy(i), s = ly(i), l = sy(o), h = ly(o), d = sy(a), p = ly(a), g = sy(u), y = ly(u),
            v = sy(c), _ = ly(c), b = {
                a: function (t) {
                    return a[t.getDay()]
                }, A: function (t) {
                    ...
                    return u[t.getMonth()]
                }, c: null, d: zy, e: zy, f: Oy, g: $y, G: Zy, H: Dy, I: qy, j: Ry, L: Fy, m: Iy, M: Uy, p: function (t) {
                    return i[+(t.getHours() >= 12)]
                }, q: function (t) {
                    return 1 + ~~(t.getMonth() / 3)
                }, Q: bv, s: mv, S: By, u: Yy, U: Ly, V: Hy, w: Xy, W: Gy, x: null, X: null, y: Vy, Y: Wy, Z: Ky, "%": _v
            }, m = {
                a: function (t) {
                ...
                }, c: null, d: Qy, e: Qy, f: rv, g: pv, G: yv, H: Jy, I: tv, j: nv, L: ev, m: iv, M: ov, p: function (t) {
                    return i[+(t.getUTCHours() >= 12)]
                }, q: function (t) {
                    return 1 + ~~(t.getUTCMonth() / 3)
                }, Q: bv, s: mv, S: av, u: uv, U: cv, V: sv, w: lv, W: hv, x: null, X: null, y: dv, Y: gv, Z: vv, "%": _v
            }, x = {
                a: function (t, n, e) {
                    ...
                    return A(t, n, e, r)
                }, d: wy, e: wy, f: ky, g: _y, G: vy, H: Ay, I: Ay, j: My, L: Ey, m: xy, M: Ty, p: function (t, n, e) {
                    var r = f.exec(n.slice(e));
                    return r ? (t.p = s.get(r[0].toLowerCase()), e + r[0].length) : -1
                }, q: my, Q: Cy, s: Py, S: Sy, u: dy, U: py, V: gy, w: hy, W: yy, x: function (t, n, r) {
                    return A(t, e, n, r)
                }, X: function (t, n, e) {
                    return A(t, r, n, e)
                }, y: _y, Y: vy, Z: by, "%": Ny
    ...
    var ry, iy = {"-": "", _: " ", 0: "0"}, oy = /^\s*\d+/, ay = /^%/, uy = /[\\^$*+?|[\]().{}]/g;
    ...
    var qv = Dv("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
        ...
        jv = Dv("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab"), Hv = t => hr(t[t.length - 1]),
        ...
        H_ = Hv(j_);
    var X_ = Lr(tr(300, .5, 0), tr(-240, .5, 1)), G_ = Lr(tr(-100, .75, .35), tr(80, 1.5, .8)),
        V_ = Lr(tr(260, .75, .35), tr(80, 1.5, .8)), $_ = tr();
    var W_ = ve(), Z_ = Math.PI / 3, K_ = 2 * Math.PI / 3;
    ...
    var ib = Math.abs, ob = Math.atan2, ab = Math.cos, ub = Math.max, cb = Math.min, fb = Math.sin, sb = Math.sqrt,
        lb = 1e-12, hb = Math.PI, db = hb / 2, pb = 2 * hb;
    ...
    function Mb(t, n, e, r, i, o, a) {
        var u = t - e, c = n - r, f = (a ? o : -o) / sb(u * u + c * c), s = f * c, l = -f * u, h = t + s, d = n + l,
            p = e + s, g = r + l, y = (h + p) / 2, v = (d + g) / 2, _ = p - h, b = g - d, m = _ * _ + b * b, x = i - o,
            w = h * g - p * d, M = (b < 0 ? -1 : 1) * sb(ub(0, x * x * m - w * w)), A = (w * b - _ * M) / m,
    ...
    function Pb(t, n, e) {
        var r = null, i = rb(!0), o = null, a = Eb, u = null;
    ...
    function Ub() {
        var t = Pb().curve(qb), n = t.curve, e = t.lineX0, r = t.lineX1, i = t.lineY0, o = t.lineY1;
    ...
    function jb(t) {
        var n = Yb, e = Lb, r = kb, i = Nb, o = null;
    ...
    function Gb(t, n, e, r, i) {
        var o = Bb(n, e), a = Bb(n, e = (e + i) / 2), u = Bb(r, e), c = Bb(r, i);
    ...
    }, Wb = Math.sqrt(1 / 3), Zb = 2 * Wb, Kb = {
        draw: function (t, n) {
            var e = Math.sqrt(n / Zb), r = e * Wb;
            t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath()
        }
    }, Qb = Math.sin(hb / 10) / Math.sin(7 * hb / 10), Jb = Math.sin(pb / 10) * Qb, tm = -Math.cos(pb / 10) * Qb, nm = {
        draw: function (t, n) {
            var e = Math.sqrt(.8908130915292852 * n), r = Jb * e, i = tm * e;
            t.moveTo(0, -e), t.lineTo(r, i);
            for (var o = 1; o < 5; ++o) {
                var a = pb * o / 5, u = Math.cos(a), c = Math.sin(a);
    ...
    }, om = -.5, am = Math.sqrt(3) / 2, um = 1 / Math.sqrt(12), cm = 3 * (um / 2 + 1), fm = {
        draw: function (t, n) {
            var e = Math.sqrt(n / cm), r = e / 2, i = e * um, o = r, a = e * um + e, u = -o, c = a;
    ...
    dm.prototype = {
        ...
        areaStart: lm, areaEnd: lm, lineStart: function () {
    ...
    Dm.prototype = {
        ...
        areaStart: function () {
            ...
            if (e) if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]); else for (var r = Lm(t), i = Lm(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
    ...
    tx.prototype = {
        constructor: tx, scale: function (t) {
    ...
    ex.prototype = tx.prototype, t.Adder = g, t.Delaunay = nu, t.FormatSpecifier = uc, t.InternMap = y, t.InternSet = v, t.Voronoi = Wa, t.active = function (t, n) {
        ...
        var t = vb, n = _b, e = rb(0), r = null, i = bb, o = mb, a = xb, u = null;

        function c() {
            var c, f, s = +t.apply(this, arguments), l = +n.apply(this, arguments), h = i.apply(this, arguments) - db,
                d = o.apply(this, arguments) - db, p = ib(d - h), g = d > h;
            if (u || (u = c = fa()), l < s && (f = l, l = s, s = f), l > lb) if (p > pb - lb) u.moveTo(l * ab(h), l * fb(h)), u.arc(0, 0, l, h, d, !g), s > lb && (u.moveTo(s * ab(d), s * fb(d)), u.arc(0, 0, s, d, h, g)); else {
                var y, v, _ = h, b = d, m = h, x = d, w = p, M = p, A = a.apply(this, arguments) / 2,
                    T = A > lb && (r ? +r.apply(this, arguments) : sb(s * s + l * l)),
                    S = cb(ib(l - s) / 2, +e.apply(this, arguments)), E = S, k = S;
                if (T > lb) {
                    var N = yb(T / s * fb(A)), C = yb(T / l * fb(A));
                    (w -= 2 * N) > lb ? (m += N *= g ? 1 : -1, x -= N) : (w = 0, m = x = (h + d) / 2), (M -= 2 * C) > lb ? (_ += C *= g ? 1 : -1, b -= C) : (M = 0, _ = b = (h + d) / 2)
                }
                var P = l * ab(_), z = l * fb(_), D = s * ab(x), q = s * fb(x);
                if (S > lb) {
        ...
        return b.invert = function (e) {
            ...
            return arguments.length ? (v = null == t ? (d = e = r = i = null, fl) : Us(d = +t[0][0], e = +t[0][1], r = +t[1][0], i = +t[1][1]), _()) : null == d ? null : [[d, e], [r, i]]
        }, b.scale = function (t) {
        ...
        var e = t[0] * Sc, r = t[1] * Sc, i = n[0] * Sc, o = n[1] * Sc, a = Cc(r), u = Fc(r), c = Cc(o), f = Fc(o),
            s = a * Cc(e), l = a * Fc(e), h = c * Cc(i), d = c * Fc(i), p = 2 * Yc(Ic(Lc(o - r) + a * c * Lc(i - e))),
        ...
        var t = Db, n = zb, e = null, r = rb(0), i = rb(pb), o = rb(0);

        function a(a) {
            var u, c, f, s, l, h = (a = Tb(a)).length, d = 0, p = new Array(h), g = new Array(h),
                y = +r.apply(this, arguments), v = Math.min(pb, Math.max(-pb, i.apply(this, arguments) - y)),
        ...
        var t, n, e, r = ox, i = ax, o = sx, a = cx, u = fx, c = [0, 1 / 0], f = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]],
        ...
        function M(t, ...n) {
            if (r.apply(this, arguments)) {
                var e = x(this, n).event(t), i = this.__zoom,
                    u = Math.max(c[0], Math.min(c[1], i.k * Math.pow(2, a.apply(this, arguments)))), s = In(t);
        ...
        function A(t, ...n) {
            if (!e && r.apply(this, arguments)) {
                var i = x(this, n, !0).event(t), a = Dn(t.view).on("mousemove.zoom", h, !0).on("mouseup.zoom", d, !0),
                    u = In(t, c), c = t.currentTarget, s = t.clientX, l = t.clientY;
        ...
        function T(t, ...n) {
            if (r.apply(this, arguments)) {
                var e = this.__zoom, a = In(t.changedTouches ? t.changedTouches[0] : t, this), u = e.invert(a),
        ...
        function k(t, ...r) {
            if (this.__zooming) {
                ...
                if (a.touch1 && !a.touch0 && (a.touch0 = a.touch1, delete a.touch1), a.touch0) a.touch0[1] = this.__zoom.invert(a.touch0[0]); else if (a.end(), 2 === a.taps && (o = In(o, this), Math.hypot(n[0] - o[0], n[1] - o[1]) < g)) {
        ...
        return y.transform = function (t, n, e, r) {
            ...
            return arguments.length ? (i = "function" == typeof t ? t : Qm([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]), y) : i
    ...
    },t.zoomIdentity = nx,t.zoomTransform = ex,Object.defineProperty(t, "__esModule", {value: !0})
}));
